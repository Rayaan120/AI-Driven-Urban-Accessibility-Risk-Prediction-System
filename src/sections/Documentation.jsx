...
import { FileText, Download, ExternalLink, Shield, Presentation, FileSearch, CheckCircle } from 'lucide-react';
        ...
        >
            ...
            <div className="text-center space-y-4">
                ...
                <p className="text-gray-400 max-w-2xl mx-auto">
                    Access formal reports, ethical screenings, and technical presentations related to the ARiS project.
                </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {documents.map((doc, index) => (
                    <motion.div
                        ...
                        className="glass-card group relative p-8 rounded-3xl border border-white/5 hover:border-primary/30 transition-all duration-500 overflow-hidden"
                    >
                        {/* Background Decor */}
